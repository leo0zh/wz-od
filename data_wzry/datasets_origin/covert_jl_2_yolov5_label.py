...
if __name__ == '__main__':
    ...
    path_base = "/Users/leo/Desktop/datasets_hero"
    path_anno = Path(path_base) / Path("./labels_jl")
    path_classes = Path(path_base) / Path("./classes.txt")
    path_labels = Path(path_base) / Path("./labels")
