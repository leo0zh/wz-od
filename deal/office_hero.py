...
if __name__ == '__main__':
    """
    官方 https://pvp.qq.com/web201605/herolist.shtml
    转png
    """
    input = "/Users/leo/Desktop/yolo-data/hero_office"
    out = os.path.abspath(os.path.join(input, "../out"))

    if os.path.exists(out):
        os.system(f"rm -rf {out}")
    os.makedirs(out)

    for h_img in os.listdir(input):
        img = webp2png(h_img)
        img.save(source.replace("webp", "jpg"), "jpeg")
